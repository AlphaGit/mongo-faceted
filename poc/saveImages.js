...
databaseConnection.initDbConnection(function (mongoose) {
  ...
  var images = [];
  images.push(imageGenerator(100, 100, 'JDAvatar.png',
    ['JD', 'Avatar', 'person', 'face', 'color']));
  images.push(imageGenerator(100, 100, 'Another100.png',
    ['person', 'square']));
  images.push(imageGenerator(1090, 1920, 'background.png',
    ['background', 'color', 'hd', 'big', 'landscape']));
  images.push(imageGenerator(200, 200, 'PersonTagOnly.png',
    ['person']));
